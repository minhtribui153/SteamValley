...
class World(BaseScene):
    ...
    def add_entity(self, entity_type: EntityType, x: int = 0, y: int = 0, sound_on: bool = True) -> int:
        self
        new_entity = EntityFactory.create(entity_type=entity_type, sound_on=sound_on, x=x, y=y)
