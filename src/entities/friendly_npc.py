...
from common.sound import get_sound
from common.types import EntityType, QuestName
from config import ASSET_DIR, GameConfig, NpcConfig
...
class FriendlyNpc(AnimatedEntity):
    ...
    def __init__(self, npc_config, sound_on, *args, **kwargs):
